...
- `<server>/` - configuration and state for an server
  ...
  - `environment` - if present these settings will be added to the environment. This file is supported by both container and direct execution unlike `environment.sh`
